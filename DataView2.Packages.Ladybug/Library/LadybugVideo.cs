...
namespace LadybugAPI
{
	...
	unsafe public class LadybugVideo
    {
        /** 
        ...
        public const string LADYBUGVIDEO_DLL = "LadybugVideo.dll";
         ...
         */
        [DllImport(LADYBUGVIDEO_DLL, EntryPoint = "ladybugCreateVideoContext", CallingConvention = CallingConvention.Cdecl)]
         ...
         */
        [DllImport(LADYBUGVIDEO_DLL, EntryPoint = "ladybugDestroyVideoContext", CallingConvention = CallingConvention.Cdecl)]
         ...
         */
        [DllImport(LADYBUGVIDEO_DLL, EntryPoint = "ladybugOpenVideo", CallingConvention = CallingConvention.Cdecl)]
         ...
         */
        [DllImport(LADYBUGVIDEO_DLL, EntryPoint = "ladybugCloseVideo", CallingConvention = CallingConvention.Cdecl)]
         ...
         */
        [DllImport(LADYBUGVIDEO_DLL, EntryPoint = "ladybugAppendVideoFrame", CallingConvention = CallingConvention.Cdecl)]
