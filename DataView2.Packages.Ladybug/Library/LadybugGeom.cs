...
/** 
 * @defgroup LadybugGeom_cs LadybugGeom.cs
 * 
 *  LadybugGeom.cs
 *
 *      This file defines the interface of Ladybug SDK's geometry-related functions.
 *      (ie: rectification, 3d-mapping, etc.)
 *      If your C# project uses Ladybug SDK's geometry-related functions, this file
...
namespace LadybugAPI
{
	...
	unsafe public struct LadybugImage3d
	{
	   public uint uiRows; /**< The number of rows in the image. */
	   public uint uiCols; /**< The number of columns in the image. */
	   ...
	   public float fCylHeightMin; /**< Cylindrical height minimum. */
	   public float fCylHeightMax; /**< Cylindrical height maximum. */
	   public LadybugPoint3d* ppoints;  /**< The area for the pixel data. */
    ...
    // Ladybug APIs defined in ladybuggeom.h
	unsafe public partial class Ladybug
    {
        /** 
         * @defgroup ManagedGeneralMethods General Methods
         *
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugLoadConfig", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError LoadConfig(IntPtr context, string path);
         ...
         * @return A LadybugError indicating the success of the function.       
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGet3dMap", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError Get3dMap(
				IntPtr context,
				uint uiCamera,
				uint uiGridCols,
				uint uiGridRows,
         ...
         * @return A LadybugError indicating the success of the function.     
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugXYZtoRC", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError XYZtoRC(
				IntPtr context,
				double dLadybugX,
				double dLadybugY,
				double dLadybugZ,
				uint uiCamera,
				out double pdRectifiedRow,
				out double pdRectifiedCol,
				out double pdNormalized);
         ...
         * @return A LadybugError indicating the success of the function.   
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugRCtoXYZ", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError RCtoXYZ(
				IntPtr context,
				double dRectifiedRow,
				double dRectifiedCol,
				uint uiCamera,
				out double pdLocationX,
				out double pdLocationY,
				out double pdLocationZ,
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetPanoramicViewingAngle", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetPanoramicViewingAngle(
				IntPtr context,
         ...
         *   ladybugGet3dMapRotation()
         */
		[DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetPanoramicViewingAngle", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetPanoramicViewingAngle(
				IntPtr context,
				out LadybugPanoAngle panoViewAngle );
         ...
         */
		[DllImport(LADYBUG_DLL, EntryPoint = "ladybugSet3dMapRotation", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError Set3dMapRotation(IntPtr context, double dRx, double dRy, double dRz);
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGet3dMapRotation", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError Get3dMapRotation(IntPtr context, out double dRx, out double dRy, out double dRz);
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSet3dMapSphereSize", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError Set3dMapSphereSize(IntPtr context, double dRadius);
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGet3dMapSphereSize", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError Get3dMapSphereSize(IntPtr context, out double dRadius);
         ...
         *
         * @param  context  - The LadybugContext to access.
         * @param  onePush  - If true, dynamic stitching is applied to the current
         *                    3D map one time.
         * @param  auto     - If true, dynamic stitching is executed every time
         ...
         * @param  point    - The 3D coordinates where dynamic stitching should be 
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetDynamicStitching", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetDynamicStitching(IntPtr context, bool onePush, bool auto, ref LadybugPoint3d point);
         ...
         *   ladybugGetDynamicStitchingParams()
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetDynamicStitching", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetDynamicStitching(IntPtr context, out bool auto);
         ...
         *   LadybugDynamicStitchingParams struct
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetDynamicStitchingParams", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetDynamicStitchingParams(IntPtr context, ref LadybugDynamicStitchingParams dsparams);
         ...
         *   ladybugSetDynamicStitchingParams()
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetDynamicStitchingParams", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetDynamicStitchingParams(IntPtr context, out LadybugDynamicStitchingParams dsparams);
         ...
         */
		[DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetPanoramicMappingType", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetPanoramicMappingType(IntPtr context, LadybugMapType mappingType);
         ...
         */
		[DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetPanoramicMappingType", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetPanoramicMappingType(IntPtr context, out LadybugMapType mappingType);
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetCameraUnitFocalLength", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetCameraUnitFocalLength(IntPtr context, int camera, out double focalLength);
         ...
         * @see ladybugSetOffScreenImageSize()
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetCameraUnitImageCenter", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetCameraUnitImageCenter(IntPtr context, int camera, out double centerX, out double centerY);
         ...
         * @return A LadybugError indicating the success of the function.  
         */
		[DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetCameraUnitExtrinsics", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetCameraUnitExtrinsics(IntPtr context, int camera, double[] ardEulerZYX);
         ...
         */
		[DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetZAxis", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetZAxis(IntPtr context, ref LadybugPoint3d pPoints, int iNumPoints);

        /*@}*/

        /** 
         * @defgroup ManagedAlphaMaskMethods Alpha Mask Methods
         *
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugInitializeAlphaMasks", CallingConvention = CallingConvention.Cdecl)]
         ...
         */
		[DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetAlphaMaskPathname", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetAlphaMaskPathname(
                IntPtr context,
				ref string filename);
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugLoadAlphaMasks", CallingConvention = CallingConvention.Cdecl)]
         ...
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetAlphaMasking", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetAlphaMasking(IntPtr context, bool enable);
         ...
         * @return A LadybugError indicating the success of the function.     
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetBlendingParams", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError SetBlendingParams(IntPtr context, double dMaxBlendingWidth);
         ...
         * @return A LadybugError indicating the success of the function.     
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetBlendingParams", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetBlendingParams(IntPtr context, out double dMaxBlendingWidth);
         ...
         * @return A LadybugError indicating the success of the function.     
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugGetAlphaMask", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError GetAlphaMask(
				IntPtr context,
				uint uiCamera,
				uint uiCols,
				uint uiRows,
				out byte** ppAlphaImage);

        /*@}*/

        /** 
         * @defgroup ManagedImageRectificationMethods Image Rectification Methods
         *
         ...
         * @see ladybugSetOffScreenImageSize()
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugUnrectifyPixel", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError UnrectifyPixel(
                IntPtr context, 
                uint camera, 
                double rectifiedRow, 
                double rectifiedCol, 
                ref double distortedRow, 
                ref double distoredCol);
         ...
         * @see   ladybugSetOffScreenImageSize()
         */
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugRectifyPixel", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError RectifyPixel(
				IntPtr context,
				uint uiCamera,
				double dDistortedRow,
				double dDistortedCol,
				ref double pdRectifiedRow,
				ref double pdRectifiedCol);
